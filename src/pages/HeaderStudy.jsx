...
import { BigTitle, SmaillTitle } from '../styles/StyledComponent';
...
const HeaderStudy = () => {
    return(
        <>
        <StudyHeader>
        <NavLink to="/Study/StudyRoom/StudyRoomHome" style={({isActive}) =>{
                      return isActive ? navSelect : navDefault
                    }}>홈</NavLink>
                    <NavLink to="/Study/StudyRoom/StudyRoomSchedule" style={({isActive}) =>{
                      return isActive ? navSelect : navDefault
                    }}>일정</NavLink>
                    <NavLink to="/Study/StudyRoom/StudyRoomBoard" style={({isActive}) =>{
                      return isActive ? navSelect : navDefault
                    }}>보드</NavLink>
                    <NavLink to="/study/StudyRoom/StudyRoomMember" style={({isActive}) =>{
                      return isActive ? navSelect : navDefault
                    }}>멤버</NavLink>
        </StudyHeader>
        <StudyInfo
